...
function CookiesPage() {
    return (
      <div className="cookies">
        <h1 className="cookies__header">Política de Cookies</h1>
        <p className="cookies__text">Debido a la entrada en vigor de la referente modificación de la “Ley de Servicios de la Sociedad de la Información” (LSSICE) establecida por el Real Decreto 13/2012, es de obligación obtener el consentimiento expreso del usuario de todas las páginas web que usan cookies prescindibles, antes de que éste navegue por ellas.</p>
        <h2 className="cookies__title">¿Qué son las cookies?</h2>
        <p className="cookies__text">Las cookies y otras tecnologías similares tales como local shared objects, flash cookies o píxeles, son herramientas empleadas por los servidores Web para almacenar y recuperar información acerca de sus visitantes, así como para ofrecer un correcto funcionamiento del sitio.<br />
        ...
        <h2 className="cookies__title">Cookies afectadas por la normativa y cookies exceptuadas</h2>
        <p className="cookies__text">Según la directiva de la UE, las cookies que requieren el consentimiento informado por parte del usuario son las cookies de analítica y las de publicidad y afiliación, quedando exceptuadas las de carácter técnico y las necesarias para el funcionamiento del sitio web o la prestación de servicios expresamente solicitados por el usuario.</p>
        <h2 className="cookies__title">¿Qué tipos de cookies existen?</h2>
        <h3 className="cookies__subtitle">Según su titularidad</h3>
        <ul className="cookies__text">
        ...
        <h3 className="cookies__subtitle">Según su duración</h3>
        <ul className="cookies__text">
        ...
        <h3 className="cookies__subtitle">Según su funcionalidad</h3>
        <ul className="cookies__text">
